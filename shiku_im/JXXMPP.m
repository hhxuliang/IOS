...
- (void)onSocket:(AsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag
{
    ...
    if(TranObjectType==5){
        ...
        if(msg.type != nil ){
            ...
            [msg save];
            NSString *ack_format=@"{\"TranObjectType\":16,\"fromUser\":%@,\"toUser\":0,\"crowd\":0,\"fromusername\":\"null\",\"fromimg\":0,\"TranObject\":{\"arg1\":\"%@\",\"arg2\":\"%@\",\"arg3\":\"\"}}";
            NSString * ack = [NSString stringWithFormat:ack_format,msg.toUserId,msg.serverdatekey,msg.toUserId];
            [self sendMsg:ack];
            //}
        }
